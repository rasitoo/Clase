...
/**
 * Clase que maneja la conexión con un cliente en un hilo separado.
 */
...
class ServerThread implements Runnable {
    ...
    /**
     * Recibe un archivo del cliente y lo guarda en el servidor.
     *
    ...
    /**
     * Envía un archivo solicitado por el cliente.
     *
     * @param dis El DataInputStream para leer datos del cliente.
     * @param dos El DataOutputStream para enviar datos al cliente.
     * @throws IOException Si ocurre un error de IO.
