...
// Configurar componentes ;
		...
		setVisible(false);
		Thread.sleep(5000); // Reaparece 5 seg después
		setVisible(true);
		Thread.sleep(5000); // borro la ventana 5 seg después
		dispose();
		Thread.sleep(5000); // borro la ventana 5 seg después
		System.out.println("Se ha cerrado la ventana y se termina la aplicación");
	}
