...
import ApliCanvas.Lienzo;
import ApliCanvas.PantallaBN;
import ApliCanvas.Utilidades;
import ApliCanvas.VentanaMultimedia;
import ApliCanvas.*;
...
public class PrincipalDemoBolas {
	...
	public static void main(String[] args) {
		...
		Lienzo lienzo;
		if (pantallaBuena) {
			lienzo = new VentanaMultimedia("Ventana gráfica", 16, 16, 10, Color.BLACK);
