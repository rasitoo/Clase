...
public class CrearBilletes {
	...
	void crearFichBilletes() throws IOException {
		...
		Billete b=new Billete(1,2023,11,13,14,3,1,"12345678A");
		b.escribir(f);
		b=new Billete(2,2023,11,13,14,5,1,"12345679B");
		b.escribir(f);
		b=new Billete(1,2023,11,13,14,6,1,"12345670C");
		b.escribir(f);
		b=new Billete(1,2023,11,13,14,8,1,"12345670C");
		b.escribir(f);
		b=new Billete(2,2023,11,13,14,18,1,"12345672D");
		b.escribir(f);
		b=new Billete(1,2023,11,13,14,42,1,"12345670C");
		b.escribir(f);
		f.close();
	}
