...
public class Teclado{
	  ...
	  * 
	  * @throws IOException Por si hay error en la lectura de teclado
	  */
 ...
 * 
 * @throws IOException
 * @throws  java.lang.NumberFormatException  Si lo que he leído no es un número
 * @return double   el número leído de teclado
 */
