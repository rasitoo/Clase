...
public class personaje2 {
    ...
    personaje2(String nombre, Punto2 posicion, int vida, int fuerza, arma arma){
        this.nombre   = nombre;
        this.arma     = arma;
        this.vida     = vida;
        this.fuerza   = fuerza;
    ...
    void lucha(personaje2 contrincante){
    ...
    public static void main(String[] args) {
        ...
        String perro= e.nextLine();
        personaje2 Pepe = new personaje2(perro,new Punto2(0,0),100,30,espada);
        personaje2 Antonio = new personaje2("Antonio",new Punto2(10,10), 100, 50, martillo);
        ...
        System.out.println("la vida de " + Pepe.nombre + " es:" + Pepe.vida);
